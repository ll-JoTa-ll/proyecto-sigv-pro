...
@Component({
  selector: 'app-filtros-mini',
  templateUrl: './filtros-mini.component.html',
  styleUrls: ['./filtros-mini.component.sass']
})
export class FiltrosMiniComponent implements OnInit {
