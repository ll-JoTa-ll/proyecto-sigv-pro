import { Component, OnInit, Input, TemplateRef, ViewChild, AfterViewInit, HostListener, ElementRef, Output, EventEmitter } from '@angular/core';
...
// import { ReservaHotelComponent } from '../../hoteles/reserva-hotel/reserva-hotel.component';
...
@Component({
  selector: 'app-recomendacion-hotel-detail',
  templateUrl: './recomendacion-hotel-detail.component.html',
  styleUrls: ['./recomendacion-hotel-detail.component.sass']
})

export class RecomendacionHotelDetailComponent implements OnInit, AfterViewInit {
  ...
  constructor(private eRef: ElementRef, private localStorageService: LocalStorageService, private router: Router, private sessionStorageService: SessionStorageService, private modalService: BsModalService, private spinner: NgxSpinnerService, private _scrollToService: ScrollToService) {
    ...
    this.vuelo = this.sessionStorageService.retrieve('ss_flightavailability_request1_recomendacion');
  ...
  listadoHoteles($event) {
    this.hoteles = $event;
    this.hoteles.forEach(val=>val.vuelo = this.vuelo);
  }
